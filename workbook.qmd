...
writeRaster(elev_cropped, "spain_france_elevation.tif", overwrite = TRUE)

system("gh release list")
system("gh release upload v1 flows_north_time.parquet locations_north.parquet flows_north_time.rds locations_north.rds spain_france_elevation.tif --clobber")
```
