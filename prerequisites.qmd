...
2.  **Quarto Documents (recommended)**: You can open existing or new `.qmd` files in the editor and run code chunks interactively by typing Ctrl+Enter (or Cmd+Enter on Mac) to run the code line-by-line (or even selected parts of code), the recommended way.
