...
This requires you to have Docker installed and running on your machine, and may require admin rights to set up (see the [Docker and Dev Containers section](#sec-local-docker) for more details on local setup).
...
<details>
<summary><b>Option A: Local devcontainer (recommended if you have admin rights to install Docker)</b></summary>

### Docker and Dev Containers {.unnumbered .unlisted #sec-local-docker}
...
### R Packages {.unnumbered .unlisted #sec-packages}
...
<details>
<summary><b>Option C: Local Python/VS Code installation</b></summary>
...
### Software Requirements {.unnumbered .unlisted #sec-software-py}
...
### Installing Dependencies and Running Python {.unnumbered .unlisted}
