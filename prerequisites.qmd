...
If you prefer to run the workshop materials on your own computer, you can follow the manual setup by installing the software listed in @sec-software and the R packages described in @sec-packages, or use the Docker and Dev Containers setup described in @sec-local-docker.
...
As an alternative to installing all software manually on your computer, you can run the workshop environment locally using Docker and VS Code Dev Containers. The repository includes a pre-configured development container setup (`.devcontainer`) containing all necessary runtime tools and packages pre-installed.
